var PageNewTrip3 = (function () {
    ...
    PageNewTrip3.prototype.generateMap = function (lat, lng) {
    ...
    PageNewTrip3.prototype.generateControls = function (resultArr) {
        var latlngArray = [];
        for (var i = 0; i < resultArr.length; i++) {
            if (resultArr[i])
                latlngArray.push(L.latLng(resultArr[i].lat, resultArr[i].lng));
        }
    ...
    PageNewTrip3.prototype.$doCheck = function () {
